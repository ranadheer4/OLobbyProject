...
public class InlineEdit extends WebDriverUtility{
	...
	@FindBy(xpath = "(//span[@container='body'])[3]")private WebElement taskNameField;

	@FindBy(xpath = "//tbody[@role='presentation']/../descendant::td[@class='hover-column' and @aria-colindex='4']/../descendant::span[text()='link']")private WebElement editExistingTaskName;
...
//	@FindBy(xpath = "")private WebElement addRow;
	...
	@FindBy(xpath = "//table[@role='presentation']//input[@data-name-row='hdfc2SubFolder']")private WebElement restoreCheckbox;
	@FindBy(xpath = "//table[@role='presentation']//input[@data-name-row='FirstBook']")private WebElement restoreCheckbox2;
	...
	public WebElement getRestoreCheckbox2() {
		return restoreCheckbox2;
	}
