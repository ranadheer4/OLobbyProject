...
@FindBy(xpath = "//div[@class='modal-content cursor-draggable']//button[text()='Delete Project']")private WebElement deleteProject;

@FindBy(xpath = "//app-notification-modal//button[text()='Delete']")private WebElement deletePopUp;
