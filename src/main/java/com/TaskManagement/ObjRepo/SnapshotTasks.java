...
public class SnapshotTasks extends WebDriverUtility {
	...
	@FindBy(xpath="//span[text()='My Tasks']/../../../descendant::span[text()='Assigned to others']")
	private WebElement assignToOthersTask;
	...
	@FindBy(xpath="//a[text()='Due this week']/../../descendant::a[text()='Assigned today']")
	private WebElement assignTodayTask;
	@FindBy(xpath="//a[text()='Due this week']/../../descendant::a[text()='Unassigned due date ']")
	private WebElement unassignDuedateTask;
	@FindBy(xpath="//a[@ngbtooltip='Filter View']")private WebElement filter;
	@FindBy(xpath="//div[text()='Tasks']/../../descendant::*[local-name()='svg' and @viewBox='0 0 13 13']")
	private WebElement reloadTask;	
	@FindBy(xpath="//div[text()='Tasks']/../../descendant::*[local-name()='svg' and @viewBox='0 0 15 16']")
	private WebElement showFullScrnTask;
	...
	@FindBy(xpath="//div[text()='Assigned Project']/../descendant::span[@tabindex='0']")
	private WebElement assignProjFiltsearchTask;
	...
	@FindBy(xpath="//span[text()='All Tasks']/../../../../descendant::*[contains(@d, 'M14.8496 6')]")
	private WebElement export1;
	@FindBy(xpath="//span[text()='All Tasks']/../../../../descendant::*[contains(@d, 'M14.8496 6')]")private WebElement export;

	@FindBy(xpath="//div[@class='cdk-drag-handle modal-header']//button[@type='button']")private WebElement closeTab;
	
	public SnapshotTasks(WebDriver driver)
	{
