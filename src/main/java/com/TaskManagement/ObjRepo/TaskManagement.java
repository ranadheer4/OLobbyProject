...
public class TaskManagement extends WebDriverUtility
{
	...
	@FindBy(xpath="//button[normalize-space()='Delete Project']")private WebElement clickDeleteProject;
	@FindBy(xpath="//img[@src='assets/sidebaricons/Task.svg']/../following-sibling::div/button[text()='Delete']")private WebElement clickDelete;
