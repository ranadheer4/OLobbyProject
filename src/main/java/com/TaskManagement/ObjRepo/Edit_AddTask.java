...
@FindBy(xpath = "//app-task-details//div[@class='modal-header']//button[@type='button']")private WebElement closeWindowLogo;
@FindBy(xpath = "//div[@class='cdk-drag-handle modal-header']//button[@type='button']")private WebElement closeWinForAllTaskList;
	...
	public WebElement getCloseWindowLogo() {
		return closeWindowLogo;
	}
	public WebElement getCloseWinForAllTaskList() {
		return closeWinForAllTaskList;
	}
