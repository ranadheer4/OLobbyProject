...
public class SmokeTC_10 extends BaseClass {
	...
	@Test
	public void ChangeLocWithProj() throws InterruptedException
	{
        ...
        Thread.sleep(7000);
        WebElement hideElement = driver.findElement(By.xpath("//tbody[@role='presentation']/descendant::td[@aria-colindex='5']/div[text()=' T0000000035 ']/../../td[@aria-colindex='4']/descendant::span[text()='VikramTask']/../following-sibling::span"));
        Thread.sleep(5000);
       ...
       Thread.sleep(7000);
       WebElement hideElement1 = driver.findElement(By.xpath("//tbody[@role='presentation']/descendant::td[@aria-colindex='5']/div[text()=' T0000000035 ']/../../td[@aria-colindex='4']/descendant::span[text()='VikramTask']/../following-sibling::span"));
       Thread.sleep(5000);
	   ...
	   Thread.sleep(3000);
      et.getSave().click(); 
      String text1 = cl.getIndia().getText(); 
